...
@section('content')
    <div class="text-center mt-10">
        ...
        <p class="mb-6 text-gray-600">Silahkan <span class="font-bold text-blue-500">Daftar</span> Untuk Melanjutkan.</p>
    </div>
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div class="mx-auto w-full max-w-sm">
            <form class="space-y-6" action="{{ route('register') }}" method="POST">
                ...
                <div>
                    <label for="password_confirmation" class="block text-sm/6 font-medium text-gray-900">Konfirmasi
                        Password</label>
                    <div class="mt-2">
