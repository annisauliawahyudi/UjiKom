<div id="popup-modal-delete-{{ $pengaduan->id }}" tabindex="-1"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <button type="button"
                ...
                data-modal-hide="popup-modal-delete-{{ $pengaduan->id }}">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <!-- Form Delete -->
                <form action="{{ route('petugas.destroy', $pengaduan->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <button data-modal-hide="popup-modal-delete-{{ $pengaduan->id }}" type="submit"
                ...
                <!-- Tombol Batal -->
                <button data-modal-hide="popup-modal-delete-{{ $pengaduan->id }}" type="button"
